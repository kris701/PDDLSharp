    ...
    public class ActionGrounderTests
    {
        public static IEnumerable<object[]> GetGroundingData_Typeless_NoConstants()
        {
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){  }), null, null),
                new List<NameExp>() { new NameExp("obj1"), new NameExp("obj2") },
                1
            };
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){ new NameExp("?a") }), null, null),
                new List<NameExp>() { new NameExp("obj1"), new NameExp("obj2") },
                2
            };
            yield return new object[] {
            ...
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){ new NameExp("?a"), new NameExp("?b") }), null, null),
                new List<NameExp>() { new NameExp("obj1"), new NameExp("obj2") },
                4
            };
        }
        ...
        public static IEnumerable<object[]> GetGroundingData_NoConstants()
        {
            ...
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){ new NameExp("?a", new TypeExp("type1")) }), null, null),
                new List<NameExp>() { new NameExp("obj1", new TypeExp("type1")), new NameExp("obj2", new TypeExp("type2")) },
                1
            };
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){ new NameExp("?a", new TypeExp("type3")) }), null, null),
                new List<NameExp>() { new NameExp("obj1", new TypeExp("type1")), new NameExp("obj2", new TypeExp("type2")) },
                0
            };
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){ new NameExp("?a", new TypeExp("type1")), new NameExp("?b") }), null, null),
                new List<NameExp>() { new NameExp("obj1", new TypeExp("type1")), new NameExp("obj2") },
                2
            };
            yield return new object[] {
                new ActionDecl("act", new ParameterExp(new List<NameExp>(){ new NameExp("?a", new TypeExp("type1")), new NameExp("?b", new TypeExp("type3")) }), null, null),
                new List<NameExp>() { new NameExp("obj1", new TypeExp("type1")), new NameExp("obj2") },
                0
            };
        }
